...
// A QPlainTextEdit subclass that hosts the line number area widget.
// We use QPlainTextEdit here because it exposes the blockBoundingGeometry
// API needed to position line-number labels accurately. The main_window
// keeps using QTextEdit via a thin wrapper approach -- but for line numbers
// it is cleaner to derive from QPlainTextEdit directly.
